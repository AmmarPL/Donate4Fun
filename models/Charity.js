...
const userSchema = new mongoose.Schema({
  ...
  profile: {
    ...
    branchAddress: [{street: String, city: String, state: String, zip: Number}],
    picture: String,    //upload picture
    finishDonations: [{donationFrom: String}],
    currentDonations: [{donationFrom: String}],
    charityReviews: [{ body: String, date: Date }],
  }
}, { timestamps: true });
